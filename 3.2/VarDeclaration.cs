...
namespace SimpleCompiler
{
    public class VarDeclaration : JackProgramElement
    {
        ...
        public override void Parse(TokensStack sTokens)
        {
            ...
            if(!(sTokens.Peek() is VarType))
                throw new SyntaxErrorException("Expected type, received " + sTokens.Peek(), sTokens.Peek());
            if(!(sTokens.Peek(1) is Identifier))
                throw new SyntaxErrorException("Expected type, received " + sTokens.Peek(1), sTokens.Peek(1));
